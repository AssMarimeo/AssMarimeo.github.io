...
(function () {
  ...
  const translations = {
    ...
    it: {
      ...
      /* ---- Privacy policy ---- */
      privacy_page_title: "Privacy policy — Marimeo",
      privacy_meta_desc: "Informativa sul trattamento dei dati personali (GDPR) dell'Associazione Giovanile Marimeo.",
      priv_back: "Torna al sito",
      priv_h1: "Privacy policy",
      priv_updated: "Ultimo aggiornamento: 10 luglio 2026",
      priv_lead: "La presente informativa descrive come l'Associazione Giovanile Marimeo tratta i dati personali degli utenti che visitano questo sito o entrano in contatto con l'associazione, ai sensi del Regolamento (UE) 2016/679 (GDPR).",
      priv_s1_title: "1. Titolare del trattamento",
      priv_s1_p: "Il titolare del trattamento è l'<strong>Associazione Giovanile Marimeo</strong> (P. IVA 03318080599 · C.F. 90079590593).",
      priv_s1_email: "Email: <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>",
      priv_s1_pec: "PEC: <a href=\"mailto:associazione.marimeo@pec.it\">associazione.marimeo@pec.it</a>",
      priv_s2_title: "2. Quali dati raccogliamo",
      priv_s2_h3a: "Dati di navigazione",
      priv_s2_pa: "Come la maggior parte dei siti web, durante la normale navigazione i sistemi informatici del servizio di hosting possono raccogliere alcuni dati tecnici (ad esempio indirizzo IP, tipo di browser, data e ora della richiesta), il cui trattamento è necessario per erogare il sito in sicurezza. Questi dati non vengono utilizzati per identificare gli utenti.",
      priv_s2_h3b: "Dati forniti volontariamente",
      priv_s2_pb: "Se ci scrivi via email o compili il modulo di iscrizione come socio, trattiamo i dati che ci fornisci (ad esempio nome, cognome, contatti) al solo fine di risponderti e gestire il rapporto associativo.",
      priv_s3_title: "3. Finalità e base giuridica",
      priv_s3_li1: "<strong>Rispondere alle richieste di contatto</strong> — base giuridica: il legittimo interesse a dare riscontro / il consenso dell'interessato.",
      priv_s3_li2: "<strong>Gestire l'iscrizione e il rapporto associativo</strong> — base giuridica: l'esecuzione di un rapporto di cui l'interessato è parte e gli obblighi di legge connessi.",
      priv_s3_li3: "<strong>Garantire il funzionamento e la sicurezza del sito</strong> — base giuridica: il legittimo interesse del titolare.",
      priv_s4_title: "4. Servizi di terze parti",
      priv_s4_p: "Questo sito si appoggia ad alcuni servizi esterni che possono trattare dati per proprio conto:",
      priv_s4_li1: "<strong>Google Forms</strong> — utilizzato per il modulo di iscrizione come socio. I dati inseriti nel modulo sono trattati da Google secondo la sua informativa privacy.",
      priv_s4_li2: "<strong>Google Fonts</strong> — i caratteri tipografici sono caricati dai server di Google, che per motivi tecnici può ricevere l'indirizzo IP del visitatore.",
      priv_s4_li3: "<strong>OpenStreetMap</strong> — la mappa della casetta dell'acqua è incorporata da OpenStreetMap.",
      priv_s4_li4: "<strong>Umami</strong> — statistiche di visita anonime e aggregate. Umami <strong>non utilizza cookie</strong>, non raccoglie dati personali e non traccia i singoli utenti tra siti diversi. I dati (come pagine viste e provenienza approssimativa) sono trattati in forma anonima da Umami secondo la sua informativa privacy.",
      priv_s5_title: "5. Cookie",
      priv_s5_pa: "Questo sito <strong>non utilizza cookie di profilazione né strumenti di tracciamento a fini pubblicitari</strong>. Possono essere presenti solo cookie tecnici, necessari al corretto funzionamento del sito, per i quali non è richiesto il consenso.",
      priv_s5_pb: "Le statistiche di visita sono raccolte con <strong>Umami</strong> in forma aggregata e anonima, uno strumento che non utilizza cookie e non identifica i singoli utenti. Gli altri servizi di terze parti indicati al punto 4 possono impostare propri cookie tecnici: per maggiori dettagli si rimanda alle rispettive informative.",
      priv_s6_title: "6. Conservazione dei dati",
      priv_s6_p: "I dati sono conservati per il tempo strettamente necessario alle finalità per cui sono stati raccolti e, in ogni caso, nel rispetto degli obblighi di legge. I dati relativi ai soci sono conservati per la durata del rapporto associativo e per i termini previsti dalla normativa vigente.",
      priv_s7_title: "7. Diritti dell'interessato",
      priv_s7_p: "In qualsiasi momento hai diritto di:",
      priv_s7_li1: "accedere ai tuoi dati personali e chiederne una copia;",
      priv_s7_li2: "chiederne la rettifica o la cancellazione;",
      priv_s7_li3: "chiedere la limitazione del trattamento o opporti allo stesso;",
      priv_s7_li4: "revocare il consenso, ove il trattamento si basi su di esso;",
      priv_s7_li5: "proporre reclamo all'Autorità Garante per la protezione dei dati personali (<a href=\"https://www.garanteprivacy.it\" target=\"_blank\" rel=\"noopener\">garanteprivacy.it</a>).",
      priv_s7_pend: "Per esercitare i tuoi diritti puoi scriverci a <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>.",
      priv_s8_title: "8. Modifiche a questa informativa",
      priv_s8_p: "Potremmo aggiornare la presente informativa nel tempo. La versione pubblicata su questa pagina è sempre quella vigente; ti invitiamo a consultarla periodicamente."
    },
    ...
    en: {
      ...
      /* ---- Privacy policy ---- */
      privacy_page_title: "Privacy policy — Marimeo",
      privacy_meta_desc: "Privacy policy on the processing of personal data (GDPR) of the Marimeo Youth Association.",
      priv_back: "Back to the site",
      priv_h1: "Privacy policy",
      priv_updated: "Last updated: 10 July 2026",
      priv_lead: "This policy describes how the Marimeo Youth Association processes the personal data of users who visit this website or get in touch with the association, pursuant to Regulation (EU) 2016/679 (GDPR).",
      priv_s1_title: "1. Data controller",
      priv_s1_p: "The data controller is the <strong>Marimeo Youth Association</strong> (VAT 03318080599 · Tax code 90079590593).",
      priv_s1_email: "Email: <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>",
      priv_s1_pec: "Certified email (PEC): <a href=\"mailto:associazione.marimeo@pec.it\">associazione.marimeo@pec.it</a>",
      priv_s2_title: "2. What data we collect",
      priv_s2_h3a: "Browsing data",
      priv_s2_pa: "Like most websites, during normal browsing the hosting service's IT systems may collect some technical data (for example IP address, browser type, date and time of the request), whose processing is necessary to deliver the site securely. This data is not used to identify users.",
      priv_s2_h3b: "Data provided voluntarily",
      priv_s2_pb: "If you write to us by email or fill in the membership form, we process the data you provide (for example name, surname, contact details) solely to reply to you and manage the membership relationship.",
      priv_s3_title: "3. Purposes and legal basis",
      priv_s3_li1: "<strong>Replying to contact requests</strong> — legal basis: the legitimate interest in responding / the consent of the data subject.",
      priv_s3_li2: "<strong>Managing membership and the associative relationship</strong> — legal basis: the performance of a relationship to which the data subject is a party and the related legal obligations.",
      priv_s3_li3: "<strong>Ensuring the operation and security of the site</strong> — legal basis: the legitimate interest of the controller.",
      priv_s4_title: "4. Third-party services",
      priv_s4_p: "This site relies on some external services that may process data on their own account:",
      priv_s4_li1: "<strong>Google Forms</strong> — used for the membership form. The data entered in the form is processed by Google in accordance with its privacy policy.",
      priv_s4_li2: "<strong>Google Fonts</strong> — the typefaces are loaded from Google's servers, which for technical reasons may receive the visitor's IP address.",
      priv_s4_li3: "<strong>OpenStreetMap</strong> — the water house map is embedded from OpenStreetMap.",
      priv_s4_li4: "<strong>Umami</strong> — anonymous, aggregated visit statistics. Umami <strong>does not use cookies</strong>, does not collect personal data and does not track individual users across different sites. The data (such as page views and approximate location) is processed anonymously by Umami in accordance with its privacy policy.",
      priv_s5_title: "5. Cookies",
      priv_s5_pa: "This site <strong>does not use profiling cookies or advertising tracking tools</strong>. Only technical cookies, necessary for the site to work properly, may be present, and no consent is required for them.",
      priv_s5_pb: "Visit statistics are collected with <strong>Umami</strong> in aggregated and anonymous form, a tool that does not use cookies and does not identify individual users. The other third-party services listed in point 4 may set their own technical cookies: for more details please refer to their respective policies.",
      priv_s6_title: "6. Data retention",
      priv_s6_p: "Data is kept for the time strictly necessary for the purposes for which it was collected and, in any case, in compliance with legal obligations. Members' data is kept for the duration of the associative relationship and for the terms provided by current legislation.",
      priv_s7_title: "7. Rights of the data subject",
      priv_s7_p: "At any time you have the right to:",
      priv_s7_li1: "access your personal data and request a copy of it;",
      priv_s7_li2: "request its rectification or erasure;",
      priv_s7_li3: "request the restriction of processing or object to it;",
      priv_s7_li4: "withdraw consent, where processing is based on it;",
      priv_s7_li5: "lodge a complaint with the Italian Data Protection Authority (<a href=\"https://www.garanteprivacy.it\" target=\"_blank\" rel=\"noopener\">garanteprivacy.it</a>).",
      priv_s7_pend: "To exercise your rights you can write to us at <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>.",
      priv_s8_title: "8. Changes to this policy",
      priv_s8_p: "We may update this policy over time. The version published on this page is always the one in force; we invite you to check it periodically."
    },
    ...
    fr: {
      ...
      privacy_page_title: "Politique de confidentialité — Marimeo",
      privacy_meta_desc: "Politique de confidentialité sur le traitement des données personnelles (RGPD) de l'Association de Jeunesse Marimeo.",
      priv_back: "Retour au site",
      priv_h1: "Politique de confidentialité",
      priv_updated: "Dernière mise à jour : 10 juillet 2026",
      priv_lead: "La présente politique décrit comment l'Association de Jeunesse Marimeo traite les données personnelles des utilisateurs qui visitent ce site ou entrent en contact avec l'association, conformément au Règlement (UE) 2016/679 (RGPD).",
      priv_s1_title: "1. Responsable du traitement",
      priv_s1_p: "Le responsable du traitement est l'<strong>Association de Jeunesse Marimeo</strong> (n° TVA 03318080599 · code fiscal 90079590593).",
      priv_s1_email: "E-mail : <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>",
      priv_s1_pec: "E-mail certifié (PEC) : <a href=\"mailto:associazione.marimeo@pec.it\">associazione.marimeo@pec.it</a>",
      priv_s2_title: "2. Quelles données nous collectons",
      priv_s2_h3a: "Données de navigation",
      priv_s2_pa: "Comme la plupart des sites web, lors de la navigation normale les systèmes informatiques du service d'hébergement peuvent collecter certaines données techniques (par exemple l'adresse IP, le type de navigateur, la date et l'heure de la requête), dont le traitement est nécessaire pour fournir le site en toute sécurité. Ces données ne sont pas utilisées pour identifier les utilisateurs.",
      priv_s2_h3b: "Données fournies volontairement",
      priv_s2_pb: "Si vous nous écrivez par e-mail ou remplissez le formulaire d'adhésion, nous traitons les données que vous fournissez (par exemple nom, prénom, coordonnées) uniquement pour vous répondre et gérer la relation associative.",
      priv_s3_title: "3. Finalités et base juridique",
      priv_s3_li1: "<strong>Répondre aux demandes de contact</strong> — base juridique : l'intérêt légitime à répondre / le consentement de la personne concernée.",
      priv_s3_li2: "<strong>Gérer l'adhésion et la relation associative</strong> — base juridique : l'exécution d'une relation à laquelle la personne concernée est partie et les obligations légales connexes.",
      priv_s3_li3: "<strong>Garantir le fonctionnement et la sécurité du site</strong> — base juridique : l'intérêt légitime du responsable.",
      priv_s4_title: "4. Services de tiers",
      priv_s4_p: "Ce site s'appuie sur certains services externes qui peuvent traiter des données pour leur propre compte :",
      priv_s4_li1: "<strong>Google Forms</strong> — utilisé pour le formulaire d'adhésion. Les données saisies dans le formulaire sont traitées par Google conformément à sa politique de confidentialité.",
      priv_s4_li2: "<strong>Google Fonts</strong> — les polices de caractères sont chargées depuis les serveurs de Google, qui pour des raisons techniques peut recevoir l'adresse IP du visiteur.",
      priv_s4_li3: "<strong>OpenStreetMap</strong> — la carte de la maison de l'eau est intégrée depuis OpenStreetMap.",
      priv_s4_li4: "<strong>Umami</strong> — statistiques de visite anonymes et agrégées. Umami <strong>n'utilise pas de cookies</strong>, ne collecte pas de données personnelles et ne suit pas les utilisateurs individuels entre différents sites. Les données (comme les pages vues et la provenance approximative) sont traitées de façon anonyme par Umami conformément à sa politique de confidentialité.",
      priv_s5_title: "5. Cookies",
      priv_s5_pa: "Ce site <strong>n'utilise pas de cookies de profilage ni d'outils de suivi à des fins publicitaires</strong>. Seuls des cookies techniques, nécessaires au bon fonctionnement du site, peuvent être présents, et aucun consentement n'est requis pour ceux-ci.",
      priv_s5_pb: "Les statistiques de visite sont collectées avec <strong>Umami</strong> sous forme agrégée et anonyme, un outil qui n'utilise pas de cookies et n'identifie pas les utilisateurs individuels. Les autres services de tiers indiqués au point 4 peuvent déposer leurs propres cookies techniques : pour plus de détails, veuillez consulter leurs politiques respectives.",
      priv_s6_title: "6. Conservation des données",
      priv_s6_p: "Les données sont conservées pendant la durée strictement nécessaire aux finalités pour lesquelles elles ont été collectées et, en tout état de cause, dans le respect des obligations légales. Les données relatives aux membres sont conservées pendant la durée de la relation associative et pendant les délais prévus par la réglementation en vigueur.",
      priv_s7_title: "7. Droits de la personne concernée",
      priv_s7_p: "À tout moment, vous avez le droit de :",
      priv_s7_li1: "accéder à vos données personnelles et en demander une copie ;",
      priv_s7_li2: "en demander la rectification ou l'effacement ;",
      priv_s7_li3: "demander la limitation du traitement ou vous y opposer ;",
      priv_s7_li4: "retirer votre consentement, lorsque le traitement repose sur celui-ci ;",
      priv_s7_li5: "introduire une réclamation auprès de l'Autorité italienne de protection des données (<a href=\"https://www.garanteprivacy.it\" target=\"_blank\" rel=\"noopener\">garanteprivacy.it</a>).",
      priv_s7_pend: "Pour exercer vos droits, vous pouvez nous écrire à <a href=\"mailto:associazione.marimeo@gmail.com\">associazione.marimeo@gmail.com</a>.",
      priv_s8_title: "8. Modifications de la présente politique",
      priv_s8_p: "Nous pouvons mettre à jour la présente politique au fil du temps. La version publiée sur cette page est toujours celle en vigueur ; nous vous invitons à la consulter régulièrement."
    }
  };
