...
(function () {
  ...
  const translations = {
    ...
    it: {
      ...
      join_card_b2: "Prezzo di erogazione vantaggioso (-35%)",
      join_card_b3: "Ricaricare facilmente alla casetta",
      drink_card_title: "Bevi",
    ...
    en: {
      ...
      join_card_b2: "Get a discounted price per litre (-35%)",
      join_card_b3: "Top up easily at the water house",
      drink_card_title: "Drink",
    ...
    fr: {
      ...
      join_card_b2: "Bénéficier d'un prix de distribution avantageux (-35 %)",
      join_card_b3: "Recharger facilement à la maison de l'eau",
      drink_card_title: "Buvez",
